...
from app.api import cases, demo, live, missions, replay, stations, transit
...
for r in (stations.router, cases.router, missions.router, live.router, replay.router, transit.router, demo.router):
